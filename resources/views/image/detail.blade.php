        ...
        <div class="col-md-8">
            ...
            <div class="card mb-5">
                ...
                <div class="card-footer">
                    ...
                    @if ($userlike)
                        <img src="{{asset('img/heart-red.png')}}" style="cursor:pointer;" class="btn-dislike icons" data-id="{{$image->id}}"/>
                    @else
                        <img src="{{asset('img/heart-black.png')}}" style="cursor:pointer;" class="btn-like icons" data-id="{{$image->id}}"/>
                    @endif
                    ...
                    <p class="mb-2 mt-2"><span class="font-weight-bold">{{$image->user->username}}:</span> {{ $image->description }}</p>
